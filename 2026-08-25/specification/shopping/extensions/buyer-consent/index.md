...
On `complete_checkout`, businesses MUST NOT transition the checkout to `completed` while a confirmed consent decision has unmet data dependencies. Missing dependencies MUST be surfaced via the standard [Error Handling](http://ucp.dev/2026-08-25/specification/shopping/checkout/#error-handling) flow.
