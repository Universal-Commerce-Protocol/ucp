...
Base [Context](http://ucp.dev/2026-08-25/specification/shopping/catalog/#context) defines an optional `location`: a stable, opaque [Location](http://ucp.dev/2026-08-25/specification/glossary/#commerce) identifier in the Business's namespace. The field appears on Catalog requests and on Cart and Checkout create and update requests (see [Checkout Context](http://ucp.dev/2026-08-25/specification/shopping/checkout/#context)). Fulfillment does not add or redefine the field; when the Fulfillment extension is active, it defines the field's effects.
...
| ----------- | ------------------------------------------------------------------------------------- | ----------------------------- | -------------------- |
| fulfillment | [Fulfillment](/2026-08-25/specification/shopping/extensions/fulfillment/#fulfillment) | Optional; omitted on complete | Fulfillment details. |
...
| Name              | Type                                                                                                       | Requirement | Description                         |
| ----------------- | ---------------------------------------------------------------------------------------------------------- | ----------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method](/2026-08-25/specification/reference/#fulfillment-method)\]                     | Optional    | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method](/2026-08-25/specification/reference/#fulfillment-available-method)\] | Optional    | Inventory availability hints.       |
...
| destinations            | Array\[[Fulfillment Destination](/2026-08-25/specification/reference/#fulfillment-destination)\] | Optional     | Available destinations for this method. In Business responses, each destination carries a `type` and `id`.                                                                   |
...
| groups                  | Array\[[Fulfillment Group](/2026-08-25/specification/reference/#fulfillment-group)\]             | Optional     | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method.                                                                 |
...
| options            | Array\[[Fulfillment Option](/2026-08-25/specification/reference/#fulfillment-option)\] | Optional     | Available fulfillment options for this group.                          |
...
| description               | [Description](/2026-08-25/specification/reference/#description)       | Optional     | Supplementary context for the title (e.g. 'Arrives in 4 business days', 'Arrives Dec 12-15 via FedEx'). Directly renderable; MUST NOT repeat the title. |
...
| totals                    | Array\[[Total Response](/2026-08-25/specification/reference/#total)\] | **Required** | Fulfillment option totals breakdown.                                                                                                                    |
