...
This document specifies the REST binding for the [Checkout Capability](http://ucp.dev/2026-08-25/specification/shopping/checkout/index.md).
...
| ------------------------------------------------------------------------------------------------- | ------ | ---------------------------------- | -------------------------- |
| [Create Checkout](http://ucp.dev/2026-08-25/specification/shopping/checkout/#create-checkout)     | `POST` | `/checkout-sessions`               | Create a checkout session. |
| [Get Checkout](http://ucp.dev/2026-08-25/specification/shopping/checkout/#get-checkout)           | `GET`  | `/checkout-sessions/{id}`          | Get a checkout session.    |
| [Update Checkout](http://ucp.dev/2026-08-25/specification/shopping/checkout/#update-checkout)     | `PUT`  | `/checkout-sessions/{id}`          | Update a checkout session. |
| [Complete Checkout](http://ucp.dev/2026-08-25/specification/shopping/checkout/#complete-checkout) | `POST` | `/checkout-sessions/{id}/complete` | Place the order.           |
| [Cancel Checkout](http://ucp.dev/2026-08-25/specification/shopping/checkout/#cancel-checkout)     | `POST` | `/checkout-sessions/{id}/cancel`   | Cancel a checkout session. |
...
The response is the Checkout object; the example below shows the synchronous `completed` case. See core [Complete Checkout](http://ucp.dev/2026-08-25/specification/shopping/checkout/#complete-checkout) for status and `order` semantics.
...
Platforms **MAY** choose among authentication mechanisms (API keys, OAuth, mTLS, HTTP Message Signatures). When using HTTP Message Signatures, checkout operations follow the [Message Signatures](http://ucp.dev/2026-08-25/specification/signatures/index.md) specification.
...
See [Message Signatures - REST Request Signing](http://ucp.dev/2026-08-25/specification/signatures/#rest-request-signing) for the complete signing algorithm.
...
See [Message Signatures - REST Response Signing](http://ucp.dev/2026-08-25/specification/signatures/#rest-response-signing) for the complete signing algorithm.
