...
This document specifies the Agent2Agent Protocol (A2A) binding for [Checkout Capability](http://ucp.dev/2026-08-25/specification/shopping/checkout/index.md).
...
The URI for UCP A2A extension: `https://ucp.dev/2026-08-25/specification/reference`
...
```json
{
  "extensions": [
    {
      "uri": "https://ucp.dev/2026-08-25/specification/reference",
