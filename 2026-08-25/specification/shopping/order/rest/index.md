...
This document specifies the REST binding for the [Order Capability](http://ucp.dev/2026-08-25/specification/shopping/order/index.md).
...
For the Order Event Webhook (business -> platform push), see the [Order Capability overview](http://ucp.dev/2026-08-25/specification/shopping/order/#order-event-webhook).
...
Request and response signatures follow the [Message Signatures](http://ucp.dev/2026-08-25/specification/signatures/index.md) specification using RFC 9421 HTTP Message Signatures. See [REST Request Signing](http://ucp.dev/2026-08-25/specification/signatures/#rest-request-signing) and [REST Request Verification](http://ucp.dev/2026-08-25/specification/signatures/#rest-request-verification) for the complete algorithm.
...
- **SHOULD** sign responses per the [Message Signatures](http://ucp.dev/2026-08-25/specification/signatures/index.md) specification

See [Order Capability - Guidelines](http://ucp.dev/2026-08-25/specification/shopping/order/#operations-guidelines) for capability-level requirements that apply across all transports.
