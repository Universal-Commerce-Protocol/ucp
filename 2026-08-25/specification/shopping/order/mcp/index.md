...
This document specifies the Model Context Protocol (MCP) binding for the [Order Capability](http://ucp.dev/2026-08-25/specification/shopping/order/index.md).
...
| ----------- | ------------------------------------------------------------------------------ | ---------------------------------- |
| `get_order` | [Get Order](http://ucp.dev/2026-08-25/specification/shopping/order/#get-order) | Get the current state of an order. |

### `get_order`

Maps to the [Get Order](http://ucp.dev/2026-08-25/specification/shopping/order/#get-order) operation. Returns the current-state snapshot of an order.
...
- **MUST** implement the `get_order` tool per the [OpenRPC schema](/2026-08-25/services/shopping/mcp.openrpc.json)
