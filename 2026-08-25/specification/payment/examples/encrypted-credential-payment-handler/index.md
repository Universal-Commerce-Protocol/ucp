...
The only supported instrument schema is [CardPaymentInstrument](/2026-08-25/schemas/common/types/card_payment_instrument.json), the only supported checkout credential schema is `EncryptedCredential`, and the only supported source credential schema is [PanCredential](/2026-08-25/schemas/common/types/pan_credential.json).
...
1. **Verify Binding:** Confirm the decrypted `binding` matches the resource being processed, comparing `type` and `id`
...
- **Instrument Schema:** [schemas/common/types/card_payment_instrument.json](/2026-08-25/schemas/common/types/card_payment_instrument.json)
