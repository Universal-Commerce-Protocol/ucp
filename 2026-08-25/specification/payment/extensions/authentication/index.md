...
The Payment Authentication extension defines browser-surface interactions that a Platform may need to process while a payment attempt is underway. It declares two concrete [Action types](http://ucp.dev/2026-08-25/specification/overview/#actions):
      ...
      "dev.ucp.common.payment.authentication": [
        {
          ...
          "spec": "https://ucp.dev/2026-08-25/specification/payment/extensions/authentication",
...
```json
{
  "ucp": {
    ...
    "payment_handlers": {
      "com.example.card": [
        { "id": "card_handler_1", "version": "2026-08-25" }
      ]
    }
  },
  "id": "checkout_123",
...
These Action types use the parent Checkout lifecycle defined in [Checkout — Actions](http://ucp.dev/2026-08-25/specification/shopping/checkout/#actions):
...
- [Payment Device Data Collection](http://ucp.dev/2026-08-25/specification/payment/extensions/actions/device-data-collection/index.md)
- [Payment 3DS Challenge](http://ucp.dev/2026-08-25/specification/payment/extensions/actions/three-ds-challenge/index.md)
...
These are diagnostic surface codes, never authentication or payment outcomes. Following [Error Code](/2026-08-25/schemas/common/types/error_code.json), the set stays open: a surface **MAY** send another value, and a Platform **MUST** tolerate one it does not recognize and reconcile the same way.
