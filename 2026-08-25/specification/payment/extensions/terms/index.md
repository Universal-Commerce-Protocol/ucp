...
A Buyer picks one of the options in `terms[]`, the same way they pick one [fulfillment option](http://ucp.dev/2026-08-25/specification/shopping/extensions/fulfillment/#platform-responsibilities).
...
A term with more than one schedule **MUST** be funded by a single instrument. [Split Payments](http://ucp.dev/2026-08-25/specification/payment/extensions/split-payments/index.md) composes with a term that has exactly one schedule, and not otherwise.
...
1. A [policy](http://ucp.dev/2026-08-25/specification/overview/#policies) carries the durable terms text, targeted with `applies_to` at the node the terms concern — the payment term when the terms are about payment timing, the line item when they are about the goods.
      ...
      "dev.ucp.common.payment.terms": [
        {
          ...
          "spec": "https://ucp.dev/2026-08-25/specification/payment/extensions/terms",
...
| description | [Description](/2026-08-25/specification/reference/#description)                    | Optional     | Supplementary context for the title (e.g. 'Save 5% by paying today'). Directly renderable; MUST NOT repeat the title.     |
| schedules   | Array\[[Payment Schedule](/2026-08-25/specification/reference/#payment-schedule)\] | **Required** | Payment schedules that settle this checkout under this term, in the order they come due.                                  |
...
- Process disclosures attached to terms per [Warning Presentation](http://ucp.dev/2026-08-25/specification/shopping/checkout/#warning-presentation), escalating through `continue_url` when the rendering contract cannot be honored.
