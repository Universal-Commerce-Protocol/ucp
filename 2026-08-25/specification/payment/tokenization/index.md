...
**OpenAPI:** [Tokenization API](/2026-08-25/handlers/tokenization/openapi.json)
...
| Example                                                                                                                                | Use Case                                            |
| -------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| [Processor Tokenizer](http://ucp.dev/2026-08-25/specification/payment/examples/processor-tokenizer-payment-handler/index.md)           | Business or PSP runs tokenization and processing    |
| [Platform Tokenizer](http://ucp.dev/2026-08-25/specification/payment/examples/platform-tokenizer-payment-handler/index.md)             | Platform tokenizes credentials for businesses/PSPs  |
| [Encrypted Credential Handler](http://ucp.dev/2026-08-25/specification/payment/examples/encrypted-credential-payment-handler/index.md) | Platform encrypts credentials instead of tokenizing |
...
See the full [OpenAPI specification](/2026-08-25/handlers/tokenization/openapi.json) for complete request/response schemas.
...
| Resource                | URL                                                                                                                |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------ |
| Tokenization OpenAPI    | [handlers/tokenization/openapi.json](/2026-08-25/handlers/tokenization/openapi.json)                               |
| Identity Schema         | [schemas/common/types/payment_identity.json](/2026-08-25/schemas/common/types/payment_identity.json)               |
| Binding Schema          | [schemas/common/types/binding.json](/2026-08-25/schemas/common/types/binding.json)                                 |
| Token Credential Schema | [schemas/common/types/token_credential.json](/2026-08-25/schemas/common/types/token_credential.json)               |
| Card Instrument Schema  | [schemas/common/types/card_payment_instrument.json](/2026-08-25/schemas/common/types/card_payment_instrument.json) |

______________________________________________________________________

## See Also

- **[Encrypted Credential Handler](http://ucp.dev/2026-08-25/specification/payment/examples/encrypted-credential-payment-handler/index.md)** — Alternative pattern using encryption instead of tokenize/detokenize round-trips
- **[AP2 Mandates Extension](http://ucp.dev/2026-08-25/specification/payment/extensions/ap2-mandates/index.md)** — Add cryptographic proof of checkout agreement for PSP verification
