...
> **Note:** Checkout permalinks are a REST-specific construct that extends the [REST transport binding](http://ucp.dev/2026-01-23/specification/checkout-rest/index.md). Accessing a permalink returns a redirect to the checkout UI or renders the checkout page directly.
...
| payment      | [Payment](/2026-01-23/specification/checkout/#payment)                                           | No       | Payment configuration containing handlers.                                                                                                                                                                                                                      |
| order        | [Order Confirmation](/2026-01-23/specification/checkout/#order-confirmation)                     | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
...
| ------------ | ------------------------------------------------------ | -------- | -------------------------------------------------------------- |
| id           | string                                                 | **Yes**  | The unique identifier of the checkout session.Defined in path. |
| payment      | [Payment](/2026-01-23/specification/checkout/#payment) | **Yes**  | Payment configuration containing handlers.                     |
...
- [REST Binding](http://ucp.dev/2026-01-23/specification/checkout-rest/index.md): RESTful API mapping using standard HTTP verbs and JSON payloads.
- [MCP Binding](http://ucp.dev/2026-01-23/specification/checkout-mcp/index.md): Model Context Protocol mapping for agentic interaction.
- [A2A Binding](http://ucp.dev/2026-01-23/specification/checkout-a2a/index.md): Agent-to-Agent Protocol mapping for agentic interactions.
- [Embedded Checkout Binding](http://ucp.dev/2026-01-23/specification/embedded-checkout/index.md): JSON-RPC for powering embedded checkout.
...
| Name     | Type                                             | Required | Description                           |
| -------- | ------------------------------------------------ | -------- | ------------------------------------- |
| item     | [Item](/2026-01-23/specification/checkout/#item) | **Yes**  |                                       |
...
| item      | [Item](/2026-01-23/specification/checkout/#item)            | **Yes**  |                                                        |
| quantity  | integer                                                     | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total](/2026-01-23/specification/checkout/#total)\] | **Yes**  | Line item totals breakdown.                            |
| parent_id | string                                                      | No       | Parent line item identifier for any nested structures. |
...
This object MUST be one of the following types: [Message Error](/2026-01-23/specification/checkout/#message-error), [Message Warning](/2026-01-23/specification/checkout/#message-warning), [Message Info](/2026-01-23/specification/checkout/#message-info).
...
| billing_address | [Postal Address](/2026-01-23/specification/checkout/#postal-address)         | No       | The billing address associated with this payment method.                                                                                                     |
| credential      | [Payment Credential](/2026-01-23/specification/checkout/#payment-credential) | No       | The base definition for any payment credential. Handlers define specific credential types.                                                                   |
