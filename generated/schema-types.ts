 ...
 */
export type CapabilityPlatformSchema = (Entity & {
  /**
 ...
 *
 * This interface was referenced by `UCPCapability`'s JSON-Schema
 * via the `definition` "business_schema".
 */
export type CapabilityBusinessSchema = Entity & {
  /**
   * Parent capability this extends. Present for extensions, absent for root capabilities.
   */
  extends?: string;
 ...
 *
 * This interface was referenced by `UCPCapability`'s JSON-Schema
 * via the `definition` "response_schema".
 */
 ...
 *
 * This interface was referenced by `PaymentHandler`'s JSON-Schema
 * via the `definition` "platform_schema".
 */
export type PaymentHandlerPlatformSchema = (Entity & {
  [k: string]: unknown;
}) & {
  [k: string]: unknown;
};
 ...
 * via the `definition` "business_schema".
 */
export type PaymentHandlerBusinessSchema = Entity & {
  [k: string]: unknown;
};
/**
 ...
 *
 * This interface was referenced by `UCPService`'s JSON-Schema
 * via the `definition` "platform_schema".
 */
export type ServicePlatformSchema = (Entity & {
  /**
 ...
 * via the `definition` "business_schema".
 */
export type ServiceBusinessSchema = (Entity & {
  /**
   * Transport protocol for this service binding.
   */
  transport: 'rest' | 'mcp' | 'a2a' | 'embedded';
 ...
 * via the `definition` "platform_schema".
 */
export type UCPPlatformSchema = Base & {
  services: {
    [k: string]: ServicePlatformSchema[];
  };
  capabilities?: {
    [k: string]: CapabilityPlatformSchema[];
  };
  payment_handlers: {
    [k: string]: PaymentHandlerPlatformSchema[];
  };
  [k: string]: unknown;
};
/**
 ...
 * via the `definition` "business_schema".
 */
export type UCPBusinessSchema = Base & {
  services: {
    [k: string]: ServiceBusinessSchema[];
  };
  capabilities?: {
    [k: string]: CapabilityBusinessSchema[];
  };
  payment_handlers: {
    [k: string]: PaymentHandlerBusinessSchema[];
  };
  [k: string]: unknown;
};
/**
 ...
 *
 * This interface was referenced by `UCPMetadata`'s JSON-Schema
 * via the `definition` "response_checkout_schema".
 */
 ...
 *
 * This interface was referenced by `UCPMetadata`'s JSON-Schema
 * via the `definition` "response_order_schema".
 */
 ...
 *
 * This interface was referenced by `UCPMetadata`'s JSON-Schema
 * via the `definition` "response_cart_schema".
 */
 ...
 * UCP metadata for checkout responses.
 */
export type UCPCheckoutResponseSchema1 = Base & {
  services?: {
    [k: string]: ServiceResponseSchema[];
  };
  capabilities?: {
 ...
 * UCP metadata for cart responses. No payment handlers needed pre-checkout.
 */
export type UCPCartResponseSchema1 = Base & {
  capabilities?: {
    [k: string]: CapabilityResponseSchema[];
  };
  [k: string]: unknown;
 ...
 */
export type UCPDiscoveryProfile = UCPPlatformDiscoveryProfile | UCPBusinessDiscoveryProfile;
/**
 * Full discovery profile for platforms. Exposes complete service, capability, and payment handler registries.
 */
export type UCPPlatformDiscoveryProfile = Base1 & {
 ...
 */
export type UCPBusinessDiscoveryProfile = Base1 & {
 ...
 */
export declare interface PaymentHandler {
  [k: string]: unknown;
}
/**
...
export declare interface Checkout {
  ucp: UCPCheckoutResponseSchema1;
  /**
 ...
 */
export declare interface Base1 {
  ucp: Base;
  /**
 ...
 */
export declare interface EmbeddedProtocol {
  [k: string]: unknown;
}