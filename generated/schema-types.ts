 ...
 */
export type BuyerWithConsent = Buyer & {
  consent?: Consent;
  [k: string]: unknown;
};
/**
 ...
 */
export type CheckoutWithBuyerConsent = CheckoutResponse & {
  buyer?: BuyerWithConsent;
  [k: string]: unknown;
};
/**
 ...
 * via the `definition` "checkout".
 */
export type CheckoutWithDiscount = CheckoutResponse & {
...
export declare interface Base {
  /**
   * Reverse-domain capability identifier (e.g., dev.ucp.shopping.checkout).
   */
  name?: string;
  /**
   * UCP protocol version in YYYY-MM-DD format.
