...
For transport-specific details, see [REST Binding](http://ucp.dev/draft/specification/order-rest/index.md), and [MCP Binding](http://ucp.dev/draft/specification/order-mcp/index.md)
...
**Buyer authorization** - the platform obtains buyer authorization via [Identity Linking](http://ucp.dev/draft/specification/identity-linking/index.md) with the necessary scopes, or a similar mechanism. This grants access to the buyer's orders regardless of which platform originated them.
...
| Name | Type                                   | Requirement  | Description |
| ---- | -------------------------------------- | ------------ | ----------- |
| ucp  | [Ucp](/draft/specification/order/#ucp) | **Required** |             |
