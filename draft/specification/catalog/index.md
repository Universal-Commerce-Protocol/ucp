...
| description      | [Description](/draft/specification/catalog/#description)                | **Yes**  | Product description in one or more formats.                                                      |
| url              | string                                                                  | No       | Canonical product page URL.                                                                      |
| categories       | Array\[[Category](/draft/specification/catalog/#category)\]             | No       | Product categories with optional taxonomy identifiers.                                           |
| price_range      | [Price Range](/draft/specification/catalog/#price-range)                | **Yes**  | Price range across all variants.                                                                 |
| list_price_range | [Price Range](/draft/specification/catalog/#price-range)                | No       | List price range before discounts (for strikethrough display).                                   |
| media            | Array\[[Media](/draft/specification/catalog/#media)\]                   | No       | Product media (images, videos, 3D models). First item is the featured media for listings.        |
| options          | Array\[[Product Option](/draft/specification/catalog/#product-option)\] | No       | Product options (Size, Color, etc.).                                                             |
| variants         | Array\[[Variant](/draft/specification/catalog/#variant)\]               | **Yes**  | Purchasable variants of this product. First item is the featured variant for listings.           |
| rating           | [Rating](/draft/specification/catalog/#rating)                          | No       | Aggregate product rating.                                                                        |
...
| description      | [Description](/draft/specification/catalog/#description)                  | **Yes**  | Variant description in one or more formats.                                               |
| url              | string                                                                    | No       | Canonical variant page URL.                                                               |
| categories       | Array\[[Category](/draft/specification/catalog/#category)\]               | No       | Variant categories with optional taxonomy identifiers.                                    |
| price            | [Price](/draft/specification/catalog/#price)                              | **Yes**  | Current selling price.                                                                    |
| list_price       | [Price](/draft/specification/catalog/#price)                              | No       | List price before discounts (for strikethrough display).                                  |
...
| selected_options | Array\[[Selected Option](/draft/specification/catalog/#selected-option)\] | No       | Option selections that define this variant.                                               |
| media            | Array\[[Media](/draft/specification/catalog/#media)\]                     | No       | Variant media (images, videos, 3D models). First item is the featured media for listings. |
| rating           | [Rating](/draft/specification/catalog/#rating)                            | No       | Variant rating.                                                                           |
...
| Name     | Type                                           | Required | Description                                           |
| -------- | ---------------------------------------------- | -------- | ----------------------------------------------------- |
| amount   | [Amount](/draft/specification/catalog/#amount) | **Yes**  | Amount in ISO 4217 minor units. Use 0 for free items. |
...
| Name | Type                                         | Required | Description                 |
| ---- | -------------------------------------------- | -------- | --------------------------- |
| min  | [Price](/draft/specification/catalog/#price) | **Yes**  | Minimum price in the range. |
| max  | [Price](/draft/specification/catalog/#price) | **Yes**  | Maximum price in the range. |
...
| values | Array\[[Option Value](/draft/specification/catalog/#option-value)\] | **Yes**  | Available values for this option.    |
...
| code         | [Error Code](/draft/specification/catalog/#error-code) | **Yes**  | Error code identifying the type of error. Standard errors are defined in specification (see examples), and have standardized semantics; freeform codes are permitted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
