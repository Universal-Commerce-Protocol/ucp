...
1. A [policy](http://ucp.dev/draft/specification/overview/#policies) carries the durable terms text, targeted with `applies_to` at the node the terms concern — the payment term when the terms are about payment timing, the line item when they are about the goods.
...
| ---------------- | --------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| terms            | Array\[[Payment Term](/draft/specification/reference/#payment-term)\] | Optional    | Payment terms the Buyer can choose from. An unselected term's amounts are indicative; the selected term's schedule amounts sum to the checkout total.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Name          | Type                                                         | Requirement | Description                                                                                                                                                                                                                                                 |
| ------------- | ------------------------------------------------------------ | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| accepted_term | [Payment Term](/draft/specification/reference/#payment-term) | Optional    | The payment term the Buyer accepted at checkout. Businesses MUST carry it forward so the Order states the amounts owed and when, and MUST ensure its schedule amounts sum to the Order total. The available terms are checkout state and are not projected. |
...
| description | [Description](/draft/specification/reference/#description)                    | Optional     | Supplementary context for the title (e.g. 'Save 5% by paying today'). Directly renderable; MUST NOT repeat the title.     |
| schedules   | Array\[[Payment Schedule](/draft/specification/reference/#payment-schedule)\] | **Required** | Payment schedules that settle this checkout under this term, in the order they come due.                                  |
