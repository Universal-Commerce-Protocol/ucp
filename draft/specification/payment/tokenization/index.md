...
| Example                                                                                                                           | Use Case                                            |
| --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| [Processor Tokenizer](http://ucp.dev/draft/specification/payment/examples/processor-tokenizer-payment-handler/index.md)           | Business or PSP runs tokenization and processing    |
| [Platform Tokenizer](http://ucp.dev/draft/specification/payment/examples/platform-tokenizer-payment-handler/index.md)             | Platform tokenizes credentials for businesses/PSPs  |
| [Encrypted Credential Handler](http://ucp.dev/draft/specification/payment/examples/encrypted-credential-payment-handler/index.md) | Platform encrypts credentials instead of tokenizing |
