...
```json
{
  "capabilities": {
    "dev.ucp.shopping.buyer_consent": [
      {
        "version": "draft",
        "spec": "https://ucp.dev/draft/specification/shopping/extensions/buyer-consent",
...
| links       | Array\[[Link](/draft/specification/reference/#link)\] | Optional     | Optional links providing context (e.g., privacy policy, terms).                                                                                                                                                                                                                                                                                           |
...
| links       | Array\[[Link](/draft/specification/reference/#link)\] | Optional     | Optional segment-specific links (e.g., channel terms or privacy disclosures).                                                                                                                                                                                                 |
