...
This document specifies the Model Context Protocol (MCP) binding for the [Cart Capability](http://ucp.dev/draft/specification/shopping/cart/index.md).
...
| ------------- | ---------------------------------------------------------------------------- | ---------------------- |
| `create_cart` | [Create Cart](http://ucp.dev/draft/specification/shopping/cart/#create-cart) | Create a cart session. |
| `get_cart`    | [Get Cart](http://ucp.dev/draft/specification/shopping/cart/#get-cart)       | Get a cart session.    |
| `update_cart` | [Update Cart](http://ucp.dev/draft/specification/shopping/cart/#update-cart) | Update a cart session. |
| `cancel_cart` | [Cancel Cart](http://ucp.dev/draft/specification/shopping/cart/#cancel-cart) | Cancel a cart session. |

### `create_cart`

Maps to the [Create Cart](http://ucp.dev/draft/specification/shopping/cart/#create-cart) operation.
...
Maps to the [Get Cart](http://ucp.dev/draft/specification/shopping/cart/#get-cart) operation.
...
Maps to the [Update Cart](http://ucp.dev/draft/specification/shopping/cart/#update-cart) operation.
...
Maps to the [Cancel Cart](http://ucp.dev/draft/specification/shopping/cart/#cancel-cart) operation.
