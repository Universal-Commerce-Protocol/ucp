...
This document specifies the Model Context Protocol (MCP) binding for the [Checkout Capability](http://ucp.dev/draft/specification/shopping/checkout/index.md).
...
The `meta["ucp-agent"]` field is **required** on all requests to enable [capability negotiation](http://ucp.dev/draft/specification/overview/#negotiation-protocol). The `complete_checkout` and `cancel_checkout` operations also require `meta["idempotency-key"]` for retry safety. Platforms **MAY** include additional metadata fields.
...
| ------------------- | -------------------------------------------------------------------------------------------- | -------------------------- |
| `create_checkout`   | [Create Checkout](http://ucp.dev/draft/specification/shopping/checkout/#create-checkout)     | Create a checkout session. |
| `get_checkout`      | [Get Checkout](http://ucp.dev/draft/specification/shopping/checkout/#get-checkout)           | Get a checkout session.    |
| `update_checkout`   | [Update Checkout](http://ucp.dev/draft/specification/shopping/checkout/#update-checkout)     | Update a checkout session. |
| `complete_checkout` | [Complete Checkout](http://ucp.dev/draft/specification/shopping/checkout/#complete-checkout) | Place the order.           |
| `cancel_checkout`   | [Cancel Checkout](http://ucp.dev/draft/specification/shopping/checkout/#cancel-checkout)     | Cancel a checkout session. |

### `create_checkout`

Maps to the [Create Checkout](http://ucp.dev/draft/specification/shopping/checkout/#create-checkout) operation.
...
- [Checkout](http://ucp.dev/draft/specification/shopping/checkout/#create-checkout) object.
...
Maps to the [Get Checkout](http://ucp.dev/draft/specification/shopping/checkout/#get-checkout) operation.
...
- [Checkout](http://ucp.dev/draft/specification/shopping/checkout/#get-checkout) object.

### `update_checkout`

Maps to the [Update Checkout](http://ucp.dev/draft/specification/shopping/checkout/#update-checkout) operation.
...
- [Checkout](http://ucp.dev/draft/specification/shopping/checkout/#update-checkout) object.
...
Maps to the [Complete Checkout](http://ucp.dev/draft/specification/shopping/checkout/#complete-checkout) operation.
...
- `id` (String): **Required**. The ID of the checkout session.
- `checkout` ([Checkout](http://ucp.dev/draft/specification/shopping/checkout/#complete-checkout)): **Required**. Contains payment credentials and other finalization data to execute the transaction.

#### Output Schema

- [Checkout](http://ucp.dev/draft/specification/shopping/checkout/#complete-checkout) object. See core [Complete Checkout](http://ucp.dev/draft/specification/shopping/checkout/#complete-checkout) for status and `order` semantics.

### `cancel_checkout`

Maps to the [Cancel Checkout](http://ucp.dev/draft/specification/shopping/checkout/#cancel-checkout) operation.
...
- [Checkout](http://ucp.dev/draft/specification/shopping/checkout/#cancel-checkout) object with `status: canceled`.
...
Platforms **SHOULD** authenticate agents when using MCP transport. When using HTTP Message Signatures, all checkout operations follow the [Message Signatures](http://ucp.dev/draft/specification/signatures/index.md) specification.
