...
This extension uses the cryptographic primitives defined in the [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md) specification:
...
- **Key Discovery:** `signing_keys[]` in `/.well-known/ucp` (see [Key Discovery](http://ucp.dev/2026-04-08/specification/overview/#key-discovery))

See [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md) for complete details on algorithms, key format, and key rotation.
