...
See [REST](http://ucp.dev/2026-04-08/specification/checkout-rest/#create-checkout) and [MCP](http://ucp.dev/2026-04-08/specification/checkout-mcp/#create_checkout) binding examples.
...
> **Note:** Checkout permalinks are a REST-specific construct that extends the [REST transport binding](http://ucp.dev/2026-04-08/specification/checkout-rest/index.md). Accessing a permalink returns a redirect to the checkout UI or renders the checkout page directly.
...
| line_items   | Array\[[Line Item Response](/2026-04-08/specification/reference/#line-item)\] | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| payment      | [Payment](/2026-04-08/specification/checkout/#payment)                        | No       | Payment configuration containing handlers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
This object MUST be one of the following types: [Checkout](/2026-04-08/specification/checkout/#checkout), [Error Response](/2026-04-08/specification/checkout/#error-response).
...
| ----------- | -------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| id          | string                                                               | **Yes**  | The unique identifier of the checkout session.Defined in path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| line_items  | Array\[[Line Item](/2026-04-08/specification/reference/#line-item)\] | No       | List of line items being checked out.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| buyer       | [Buyer](/2026-04-08/specification/reference/#buyer)                  | No       | Representation of the buyer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| context     | [Context](/2026-04-08/specification/reference/#context)              | No       | Provisional buyer signals for relevance and localization—not authoritative data. Businesses SHOULD use these values when verified inputs (e.g., shipping address) are absent, and MAY ignore or down-rank them if inconsistent with higher-confidence signals (authenticated account, risk detection) or regulatory constraints (export controls). Eligibility and policy enforcement MUST occur at checkout time using binding transaction data. Context SHOULD be non-identifying and can be disclosed progressively—coarse signals early, finer resolution as the session progresses. Higher-resolution data (shipping address, billing address) supersedes context. |
| signals     | [Signals](/2026-04-08/specification/reference/#signals)              | No       | Environment data provided by the platform to support authorization and abuse prevention. Values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or independently verifiable third-party attestations. All signal keys MUST use reverse-domain naming to ensure provenance and prevent collisions when multiple extensions contribute to the shared namespace.                                                                                                                                                                                                                                                                 |
| attribution | [Attribution](/2026-04-08/specification/reference/#attribution)      | No       | Platform-emitted referral and conversion-event context — campaign identifiers, click IDs, source/medium markers, etc. The same parameters platforms communicate via URL query parameters in browser-based flows.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- [REST Binding](http://ucp.dev/2026-04-08/specification/checkout-rest/index.md): RESTful API mapping using standard HTTP verbs and JSON payloads.
- [MCP Binding](http://ucp.dev/2026-04-08/specification/checkout-mcp/index.md): Model Context Protocol mapping for agentic interaction.
- [A2A Binding](http://ucp.dev/2026-04-08/specification/checkout-a2a/index.md): Agent-to-Agent Protocol mapping for agentic interactions.
- [Embedded Checkout Binding](http://ucp.dev/2026-04-08/specification/embedded-checkout/index.md): JSON-RPC for powering embedded checkout.
