...
Both `lookup_catalog` and `get_product` accept optional `filters` to narrow the returned products and variants. Filters use the same schema and AND semantics as [Search Filters](http://ucp.dev/2026-04-08/specification/catalog/search/#search-filters) — for example, a price filter excludes variants outside the specified range.
...
- [REST Binding](http://ucp.dev/2026-04-08/specification/catalog/rest/#post-cataloglookup): `POST /catalog/lookup` (batch)
- [REST Binding](http://ucp.dev/2026-04-08/specification/catalog/rest/#post-catalogproduct): `POST /catalog/product` (single)
- [MCP Binding](http://ucp.dev/2026-04-08/specification/catalog/mcp/#lookup_catalog): `lookup_catalog` tool (batch)
- [MCP Binding](http://ucp.dev/2026-04-08/specification/catalog/mcp/#get_product): `get_product` tool (single)
