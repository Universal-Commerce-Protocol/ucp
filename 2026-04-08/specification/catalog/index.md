...
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [`dev.ucp.shopping.catalog.search`](http://ucp.dev/2026-04-08/specification/catalog/search/index.md) | Search for products using query text and filters. |
| [`dev.ucp.shopping.catalog.lookup`](http://ucp.dev/2026-04-08/specification/catalog/lookup/index.md) | Retrieve products or variants by identifier.      |
...
Environment data provided by the platform to support authorization and abuse prevention. Signal values MUST NOT be buyer-asserted claims. See [Signals](http://ucp.dev/2026-04-08/specification/overview/#signals) for details and privacy requirements.
...
Platform-provided referral and conversion-event context — campaign IDs, click identifiers, and source/medium markers communicated by the platform. See [Attribution](http://ucp.dev/2026-04-08/specification/overview/#attribution) for details and consent requirements.
...
In lookup responses, each variant carries an `inputs` array for correlation: which request identifiers resolved to this variant, and whether the match was `exact` or `featured` (server-selected). See [Client Correlation](http://ucp.dev/2026-04-08/specification/catalog/lookup/#client-correlation) for details.
...
Warnings with `presentation: "disclosure"` carry notices (e.g., allergen declarations, safety warnings) that platforms must not hide or dismiss. See [Warning Presentation](http://ucp.dev/2026-04-08/specification/checkout/#warning-presentation) for the full rendering contract.
...
Agents correlate results using the `inputs` array on each variant. See [Client Correlation](http://ucp.dev/2026-04-08/specification/catalog/lookup/#client-correlation).
...
See [Warning Presentation](http://ucp.dev/2026-04-08/specification/checkout/#warning-presentation) for the full rendering contract.
...
Scope declaration, derivation, and rules for extending this set with custom scopes are defined in [Identity Linking — Scopes](http://ucp.dev/2026-04-08/specification/identity-linking/#scopes).

## Transport Bindings

The capabilities above are bound to specific transport protocols:

- [REST Binding](http://ucp.dev/2026-04-08/specification/catalog/rest/index.md): RESTful API mapping.
- [MCP Binding](http://ucp.dev/2026-04-08/specification/catalog/mcp/index.md): Model Context Protocol mapping via JSON-RPC.
