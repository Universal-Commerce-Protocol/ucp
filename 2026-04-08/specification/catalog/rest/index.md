...
This document specifies the HTTP/REST binding for the [Catalog Capability](http://ucp.dev/2026-04-08/specification/catalog/index.md).
...
| ------------------ | ------ | ----------------------------------------------------------------------------------------- | -------------------------------------- |
| `/catalog/search`  | POST   | [Search](http://ucp.dev/2026-04-08/specification/catalog/search/index.md)                 | Search for products.                   |
| `/catalog/lookup`  | POST   | [Lookup](http://ucp.dev/2026-04-08/specification/catalog/lookup/index.md)                 | Lookup one or more products by ID.     |
| `/catalog/product` | POST   | [Lookup](http://ucp.dev/2026-04-08/specification/catalog/lookup/#get-product-get_product) | Get full product detail by identifier. |

### `POST /catalog/search`

Maps to the [Catalog Search](http://ucp.dev/2026-04-08/specification/catalog/search/index.md) capability.
...
| filters    | [Search Filters](/2026-04-08/specification/reference/#search-filters)         | No       | Filter criteria to narrow search results. All specified filters combine with AND logic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| pagination | [Pagination Request](/2026-04-08/specification/reference/#pagination-request) | No       | Cursor-based pagination for list operations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| products   | Array\[[Product](/2026-04-08/specification/reference/#product)\]                | **Yes**  | Products matching the search criteria.                                |
| pagination | [Pagination Response](/2026-04-08/specification/reference/#pagination-response) | No       | Cursor-based pagination for list operations.                          |
| messages   | Array\[[Message](/2026-04-08/specification/reference/#message)\]                | No       | Errors, warnings, or informational messages about the search results. |
...
Maps to the [Catalog Lookup](http://ucp.dev/2026-04-08/specification/catalog/lookup/index.md) capability. See capability documentation for supported identifiers, resolution behavior, and client correlation requirements.
...
| filters | [Search Filters](/2026-04-08/specification/reference/#search-filters) | No       | Filter criteria to narrow returned products and variants. All specified filters combine with AND logic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| context | [Context](/2026-04-08/specification/reference/#context)               | No       | Provisional buyer signals for relevance and localization—not authoritative data. Businesses SHOULD use these values when verified inputs (e.g., shipping address) are absent, and MAY ignore or down-rank them if inconsistent with higher-confidence signals (authenticated account, risk detection) or regulatory constraints (export controls). Eligibility and policy enforcement MUST occur at checkout time using binding transaction data. Context SHOULD be non-identifying and can be disclosed progressively—coarse signals early, finer resolution as the session progresses. Higher-resolution data (shipping address, billing address) supersedes context. |
| signals | [Signals](/2026-04-08/specification/reference/#signals)               | No       | Environment data provided by the platform to support authorization and abuse prevention. Values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or independently verifiable third-party attestations. All signal keys MUST use reverse-domain naming to ensure provenance and prevent collisions when multiple extensions contribute to the shared namespace.                                                                                                                                                                                                                                                                 |
...
| messages | Array\[[Message](/2026-04-08/specification/reference/#message)\] | No       | Errors, warnings, or informational messages about the requested items.                                                                              |
...
Maps to the [Catalog Lookup](http://ucp.dev/2026-04-08/specification/catalog/lookup/#get-product-get_product) capability. Returns a singular `product` object (not an array) for full product detail page rendering.
...
| selected    | Array\[[Selected Option](/2026-04-08/specification/reference/#selected-option)\] | No       | Partial or full option selections for interactive variant narrowing. When provided, response option values include availability signals (available, exists) relative to these selections.                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| filters     | [Search Filters](/2026-04-08/specification/reference/#search-filters)            | No       | Filter criteria to narrow returned variants. All specified filters combine with AND logic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| context     | [Context](/2026-04-08/specification/reference/#context)                          | No       | Provisional buyer signals for relevance and localization—not authoritative data. Businesses SHOULD use these values when verified inputs (e.g., shipping address) are absent, and MAY ignore or down-rank them if inconsistent with higher-confidence signals (authenticated account, risk detection) or regulatory constraints (export controls). Eligibility and policy enforcement MUST occur at checkout time using binding transaction data. Context SHOULD be non-identifying and can be disclosed progressively—coarse signals early, finer resolution as the session progresses. Higher-resolution data (shipping address, billing address) supersedes context. |
| signals     | [Signals](/2026-04-08/specification/reference/#signals)                          | No       | Environment data provided by the platform to support authorization and abuse prevention. Values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or independently verifiable third-party attestations. All signal keys MUST use reverse-domain naming to ensure provenance and prevent collisions when multiple extensions contribute to the shared namespace.                                                                                                                                                                                                                                                                 |

**Output**

This object MUST be one of the following types: [Catalog Lookup Get Product Response](/2026-04-08/specification/catalog/rest/#catalog-lookup-get-product-response), [Error Response](/2026-04-08/specification/catalog/rest/#error-response).
...
All application-level outcomes return HTTP 200 with the UCP envelope and optional `messages` array. See [Catalog Overview](http://ucp.dev/2026-04-08/specification/catalog/#messages-and-error-handling) for message semantics and common scenarios.
