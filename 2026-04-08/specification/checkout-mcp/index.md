...
This document specifies the Model Context Protocol (MCP) binding for the [Checkout Capability](http://ucp.dev/2026-04-08/specification/checkout/index.md).
...
| ------------------- | ---------------------------------------------------------------------------------------- | -------------------------- |
| `create_checkout`   | [Create Checkout](http://ucp.dev/2026-04-08/specification/checkout/#create-checkout)     | Create a checkout session. |
| `get_checkout`      | [Get Checkout](http://ucp.dev/2026-04-08/specification/checkout/#get-checkout)           | Get a checkout session.    |
| `update_checkout`   | [Update Checkout](http://ucp.dev/2026-04-08/specification/checkout/#update-checkout)     | Update a checkout session. |
| `complete_checkout` | [Complete Checkout](http://ucp.dev/2026-04-08/specification/checkout/#complete-checkout) | Place the order.           |
| `cancel_checkout`   | [Cancel Checkout](http://ucp.dev/2026-04-08/specification/checkout/#cancel-checkout)     | Cancel a checkout session. |

### `create_checkout`

Maps to the [Create Checkout](http://ucp.dev/2026-04-08/specification/checkout/#create-checkout) operation.

#### Input Schema

- `checkout` ([Checkout](http://ucp.dev/2026-04-08/specification/checkout/#create-checkout)): **Required**. Contains the initial checkout session data and optional extensions.
  - Extensions (Optional):
    - `dev.ucp.shopping.buyer_consent`: [Buyer Consent](http://ucp.dev/2026-04-08/specification/buyer-consent/index.md)
    - `dev.ucp.shopping.fulfillment`: [Fulfillment](http://ucp.dev/2026-04-08/specification/fulfillment/index.md)
    - `dev.ucp.shopping.discount`: [Discount](http://ucp.dev/2026-04-08/specification/discount/index.md)
    - `dev.ucp.shopping.ap2_mandate`: [AP2 Mandates](http://ucp.dev/2026-04-08/specification/ap2-mandates/index.md)

#### Output Schema

- [Checkout](http://ucp.dev/2026-04-08/specification/checkout/#create-checkout) object.
  ...
  "result": {
    "structuredContent": {
      "ucp": {
        ...
        "payment_handlers": {
          "com.example.vendor.delegate_payment": [
            {"id": "handler_1", "version": "2026-04-08", "available_instruments": [{"type": "card"}], "config": {}}
          ]
        }
      },
      "id": "checkout_abc123",
...
Maps to the [Get Checkout](http://ucp.dev/2026-04-08/specification/checkout/#get-checkout) operation.
...
- [Checkout](http://ucp.dev/2026-04-08/specification/checkout/#get-checkout) object.

### `update_checkout`

Maps to the [Update Checkout](http://ucp.dev/2026-04-08/specification/checkout/#update-checkout) operation.

#### Input Schema

- `id` (String): **Required**. The ID of the checkout session to update.
- `checkout` ([Checkout](http://ucp.dev/2026-04-08/specification/checkout/#update-checkout)): **Required**. Contains the updated checkout session data.
  - Extensions (Optional):
    - `dev.ucp.shopping.buyer_consent`: [Buyer Consent](http://ucp.dev/2026-04-08/specification/buyer-consent/index.md)
    - `dev.ucp.shopping.fulfillment`: [Fulfillment](http://ucp.dev/2026-04-08/specification/fulfillment/index.md)
    - `dev.ucp.shopping.discount`: [Discount](http://ucp.dev/2026-04-08/specification/discount/index.md)
...
- [Checkout](http://ucp.dev/2026-04-08/specification/checkout/#update-checkout) object.
...
Maps to the [Complete Checkout](http://ucp.dev/2026-04-08/specification/checkout/#complete-checkout) operation.
...
- `id` (String): **Required**. The ID of the checkout session.
- `checkout` ([Checkout](http://ucp.dev/2026-04-08/specification/checkout/#complete-checkout)): **Required**. Contains payment credentials and other finalization data to execute the transaction.

#### Output Schema

- [Checkout](http://ucp.dev/2026-04-08/specification/checkout/#complete-checkout) object, containing a partial `order` that holds only `id` and `permalink_url`.

### `cancel_checkout`

Maps to the [Cancel Checkout](http://ucp.dev/2026-04-08/specification/checkout/#cancel-checkout) operation.
...
- [Checkout](http://ucp.dev/2026-04-08/specification/checkout/#cancel-checkout) object with `status: canceled`.

## Error Handling

UCP distinguishes between protocol errors and business outcomes. See the [Core Specification](http://ucp.dev/2026-04-08/specification/overview/#error-handling) for the complete error code registry and transport binding examples.
...
Platforms **SHOULD** authenticate agents when using MCP transport. When using HTTP Message Signatures, all checkout operations follow the [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md) specification.
...
See [Message Signatures - MCP Transport](http://ucp.dev/2026-04-08/specification/signatures/#mcp-transport) for details.
...
See [Message Signatures - REST Response Signing](http://ucp.dev/2026-04-08/specification/signatures/#rest-response-signing) for the signing algorithm (identical for MCP over HTTP).
...
1. Return errors per the [Core Specification](http://ucp.dev/2026-04-08/specification/overview/#error-handling).
...
1. Authenticate agents using one of the supported mechanisms (API keys, OAuth, mTLS, or HTTP Message Signatures per [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md)).
