...
This document specifies the REST binding for the [Checkout Capability](http://ucp.dev/2026-04-08/specification/checkout/index.md).
...
| ---------------------------------------------------------------------------------------- | ------ | ---------------------------------- | -------------------------- |
| [Create Checkout](http://ucp.dev/2026-04-08/specification/checkout/#create-checkout)     | `POST` | `/checkout-sessions`               | Create a checkout session. |
| [Get Checkout](http://ucp.dev/2026-04-08/specification/checkout/#get-checkout)           | `GET`  | `/checkout-sessions/{id}`          | Get a checkout session.    |
| [Update Checkout](http://ucp.dev/2026-04-08/specification/checkout/#update-checkout)     | `PUT`  | `/checkout-sessions/{id}`          | Update a checkout session. |
| [Complete Checkout](http://ucp.dev/2026-04-08/specification/checkout/#complete-checkout) | `POST` | `/checkout-sessions/{id}/complete` | Place the order.           |
| [Cancel Checkout](http://ucp.dev/2026-04-08/specification/checkout/#cancel-checkout)     | `POST` | `/checkout-sessions/{id}/cancel`   | Cancel a checkout session. |
...
See the [Core Specification](http://ucp.dev/2026-04-08/specification/overview/#error-handling) for the complete error code registry and transport binding examples.
...
Platforms **MAY** choose among authentication mechanisms (API keys, OAuth, mTLS, HTTP Message Signatures). When using HTTP Message Signatures, checkout operations follow the [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md) specification.
...
See [Message Signatures - REST Request Signing](http://ucp.dev/2026-04-08/specification/signatures/#rest-request-signing) for the complete signing algorithm.
...
See [Message Signatures - REST Response Signing](http://ucp.dev/2026-04-08/specification/signatures/#rest-response-signing) for the complete signing algorithm.
...
1. **OAuth 2.0**: Via `Authorization: Bearer {token}` header. Identifies the platform for agent-authenticated access, or both platform and user for user-authenticated access (see [Identity Linking](http://ucp.dev/2026-04-08/specification/identity-linking/index.md)).
