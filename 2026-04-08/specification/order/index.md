...
For transport-specific details, see [REST Binding](http://ucp.dev/2026-04-08/specification/order-rest/index.md), and [MCP Binding](http://ucp.dev/2026-04-08/specification/order-mcp/index.md)
...
**Buyer authorization** - the platform obtains buyer authorization via [Identity Linking](http://ucp.dev/2026-04-08/specification/identity-linking/index.md) with the necessary scopes, or a similar mechanism. This grants access to the buyer's orders regardless of which platform originated them.
...
| Name | Type                                        | Required | Description |
| ---- | ------------------------------------------- | -------- | ----------- |
| ucp  | [Ucp](/2026-04-08/specification/order/#ucp) | **Yes**  |             |
...
Webhook payloads **MUST** be signed by the business and verified by the platform to ensure authenticity and integrity. Signatures follow the [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md) specification using the REST binding (RFC 9421).
...
See [Message Signatures - REST Request Signing](http://ucp.dev/2026-04-08/specification/signatures/#rest-request-signing) for complete algorithm.
...
See [Message Signatures - REST Request Verification](http://ucp.dev/2026-04-08/specification/signatures/#rest-request-verification) for complete algorithm.
...
See [Message Signatures - Key Rotation](http://ucp.dev/2026-04-08/specification/signatures/#key-rotation) for zero-downtime key rotation procedures.
...
- **MUST** sign all webhook payloads per the [Message Signatures](http://ucp.dev/2026-04-08/specification/signatures/index.md) specification using RFC 9421 headers (`Signature`, `Signature-Input`, `Content-Digest`)
