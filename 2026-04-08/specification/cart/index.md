...
- [REST Binding](http://ucp.dev/2026-04-08/specification/cart-rest/#create-cart)
- [MCP Binding](http://ucp.dev/2026-04-08/specification/cart-mcp/#create_cart)

### Get Cart

Retrieves the latest state of a cart session. Returns `not_found` if the cart does not exist, has expired, or was canceled.

- [REST Binding](http://ucp.dev/2026-04-08/specification/cart-rest/#get-cart)
- [MCP Binding](http://ucp.dev/2026-04-08/specification/cart-mcp/#get_cart)
...
- [REST Binding](http://ucp.dev/2026-04-08/specification/cart-rest/#update-cart)
- [MCP Binding](http://ucp.dev/2026-04-08/specification/cart-mcp/#update_cart)
...
- [REST Binding](http://ucp.dev/2026-04-08/specification/cart-rest/#cancel-cart)
- [MCP Binding](http://ucp.dev/2026-04-08/specification/cart-mcp/#cancel_cart)

## Entities

Cart reuses the same entity schemas as [Checkout](http://ucp.dev/2026-04-08/specification/checkout/index.md). This ensures consistent data structures when converting a cart to a checkout session.
...
The same totals contract applies to cart and checkout. See [Checkout Totals](http://ucp.dev/2026-04-08/specification/checkout/#totals) for the rendering contract, accounting identity, well-known types, repeating types, and sub-line semantics.
