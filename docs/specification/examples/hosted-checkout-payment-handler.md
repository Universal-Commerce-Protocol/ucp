...
Build the `continue_url` using the Razorpay Order ID. Include a `callback_url`
for post-payment redirect back to the business.

```
https://checkout.razorpay.com/v1/checkout/order_xyz789?callback_url=https%3A%2F%2Fmerchant.example.com%2Fpayment%2Fcallback
```
...
```json
{
  ...
  "currency": "INR",
  "continue_url": "https://checkout.razorpay.com/v1/checkout/order_xyz789?...",
...
| Hosted Checkout Credential Schema | `https://ucp.dev/schemas/shopping/types/hosted_checkout_credential.json` |

---

*Document Version: 1.0 · Last Updated: 2026-01-27 · Contributed by: Razorpay ·
License: Apache 2.0*
