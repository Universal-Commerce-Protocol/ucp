...
Checkout Create and Update requests **MAY** include `fulfillment` when this
extension is active. Request payloads carry buyer-provided method selections
and selected destination or option identifiers; response payloads remain
authoritative for IDs, groups, options, costs, timing, and availability
