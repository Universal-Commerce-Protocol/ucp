...
{{ extension_schema_fields('loyalty.json#/$defs/loyalty_membership', 'shopping/extensions/loyalty') }}

#### Membership Tier

{{ extension_schema_fields('loyalty.json#/$defs/membership_tier', 'shopping/extensions/loyalty') }}

#### Membership Tier Benefit

{{ extension_schema_fields('loyalty.json#/$defs/membership_tier_benefit', 'shopping/extensions/loyalty') }}

#### Membership Reward

{{ extension_schema_fields('loyalty.json#/$defs/membership_reward', 'shopping/extensions/loyalty') }}

#### Reward Amount

{{ extension_schema_fields('loyalty.json#/$defs/reward_amount', 'shopping/extensions/loyalty') }}

#### Reward Currency

{{ extension_schema_fields('loyalty.json#/$defs/reward_currency', 'shopping/extensions/loyalty') }}

#### Earning Forecast

{{ extension_schema_fields('loyalty.json#/$defs/earning_forecast', 'shopping/extensions/loyalty') }}

#### Earning Breakdown

{{ extension_schema_fields('loyalty.json#/$defs/earning_breakdown', 'shopping/extensions/loyalty') }}
...
the [Eligibility Verification at Completion](../checkout/index.md#eligibility-verification-at-completion)
