...
The base extension supports text fields, including multi-line text via the
`multiline` hint. Additional input types and validation hints are defined by
the [Advanced Additional Fields Extension](additional-fields-advanced.md), which
extends the base additional fields capability.
