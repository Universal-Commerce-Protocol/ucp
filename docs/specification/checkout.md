...
The base extension supports text fields and multi-line text via the
`multiline` hint. Text validation hints, boolean fields, date fields, and
choice fields are defined by separate child extensions that extend the base
