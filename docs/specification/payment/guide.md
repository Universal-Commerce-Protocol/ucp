...
```json
{
  ...
  "$defs": {
    "constraint_target": {
      ...
      "allOf": [
        { "$ref": "https://ucp.dev/{{ ucp_version }}/schemas/shopping/types/card_payment_instrument.json#/$defs/constraint_target" },
        {
          "type": "object",
          "properties": {
            "tokenization_type": {
...
[Schema Authoring — Extension-Declared Action Types](site:documentation/schema-authoring/#extension-declared-action-types)
