...
Businesses declare support by adding `dev.ucp.common.ap2_mandate` to their
  ...
  "ucp": {
    ...
    "capabilities": {
      ...
      "dev.ucp.common.ap2_mandate": [
        {
          "version": "{{ ucp_version }}",
          "spec": "https://ucp.dev/{{ ucp_version }}/specification/payment/ap2-mandates",
          "schema": "https://ucp.dev/{{ ucp_version }}/schemas/common/ap2_mandate.json",
...
3. If `dev.ucp.common.ap2_mandate` is present in the intersection:
...
Once the `dev.ucp.common.ap2_mandate` capability is negotiated, the session
...
{{ extension_schema_fields('ap2_mandate.json#/$defs/dev.ucp.shopping.checkout', 'payment/ap2-mandates') }}
...
{{ extension_schema_fields('ap2_mandate.json#/$defs/ap2_with_checkout_mandate', 'payment/ap2-mandates') }}
...
{{ extension_schema_fields('ap2_mandate.json#/$defs/merchant_authorization', 'payment/ap2-mandates') }}

### AP2 Checkout Response

The `ap2` object included in checkout responses.

{{ extension_schema_fields('ap2_mandate.json#/$defs/ap2_with_merchant_authorization', 'payment/ap2-mandates') }}

### Checkout Mandate

{{ extension_schema_fields('ap2_mandate.json#/$defs/checkout_mandate', 'payment/ap2-mandates') }}
...
{{ extension_schema_fields('ap2_mandate.json#/$defs/error_code', 'payment/ap2-mandates') }}
