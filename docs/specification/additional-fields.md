...
semantics, including the `multiline` hint for multi-line text. Text validation
hints and other input types are defined by granular child extensions:
[Text Validation Additional Fields](additional-fields-text-validation.md),
[Boolean Additional Fields](additional-fields-boolean.md),
[Date Additional Fields](additional-fields-date.md), and
[Choice Additional Fields](additional-fields-choice.md).
...
- The base extension defines only `text` semantics and the `multiline` hint.
